...
int exist_sorted(collections collections_list_head, char key_name[MAX_STR_LEN]);
...
int search_and_print_collection(collections collections_list_head, char key_name[MAX_STR_LEN]);
